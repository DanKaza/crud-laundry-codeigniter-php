...
class Laporan extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['transaksi'] = $this->transaksi->getTransaksiByAllId();
    ...
    public function generatePdf()
    {
        ...
        // PdfLibrary::__construct() accepts no arguments, so instantiate without parameters.
        $pdf = new PdfLibrary();
...
$transaksi = $this->transaksi->getTransaksiByAllId();
